    ...
    try {
      ...
      if (!user.emailVerified) {
        Alert.alert(
          ...
          'Per favore verifica il tuo indirizzo email prima di accedere. Controlla la tua casella di posta per il link di verifica.',
          [
            {
              text: 'Invia nuovamente',
              onPress: () => {
                // This function doesn't exist in Firebase Auth API
                // We'll need to implement a different approach
                Alert.alert('Info', 'Questa funzionalità non è al momento disponibile. Contatta l\'amministratore.');
              }
            },
