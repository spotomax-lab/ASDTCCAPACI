...
import { collection, query, getDocs, deleteDoc, doc, orderBy, onSnapshot } from 'firebase/firestore';
...
const BookingManagement = () => {
  ...
  const fetchBookings = async () => {
    try {
      ...
      // Sostituiamo getDocs con onSnapshot per aggiornamenti in tempo reale
        ...
        },
        {
          ...
          onPress: async () => {
            try {
              ...
              // Non è più necessario filtrare manualmente grazie a onSnapshot
